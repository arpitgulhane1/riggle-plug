...
//	            bpage.clickOnCloseAddBrandTemplate();
			...
			Assert.assertTrue(bpage.isBrandImgPresent());
			bpage.closeBrandAfterVerify();
...
//	            bpage.setBrandName("Tesla"); // Remove after test run
			...
			Assert.assertTrue(bpage.isBrandDisplayed(), "❌ Brand not displayed: "); // check same value which is add as
																					// brand
