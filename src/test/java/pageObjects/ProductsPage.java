...
public class ProductsPage extends BasePage{
	...
	@FindBy(xpath = "//span[@class='ant-page-header-heading-title']") WebElement productBrandPath;
	
//	Mandatory Fields 
	@FindBy(xpath = "//button[@class='ant-btn ant-btn-primary']") WebElement addProductButton;
	@FindBy(xpath = "//input[@id='nest-messages_name']") WebElement productName;
	@FindBy(xpath = "//input[@id='nest-messages_mrp']") WebElement productMRP;
	@FindBy(xpath = "//input[@id='nest-messages_category']") WebElement productCategory;
	@FindBy(xpath = "//div[@class='ant-select-dropdown ant-select-dropdown-placement-bottomLeft ']//div[@title]") List <WebElement>  productCategoryAllOptions;
	@FindBy(xpath = "//input[@id='nest-messages_sub_category']") WebElement productSubCategory;
	@FindBy(xpath = "//div[@class='ant-select-dropdown ant-select-dropdown-placement-bottomLeft ']//div[@title]") List <WebElement>   productSubCategoryAllOptions;
	@FindBy(xpath = "//input[@id='nest-messages_base_quantity']") WebElement productUnitWT;
	
//	Not Mandatory
	@FindBy(xpath = "//input[@id='nest-messages_product_code']") WebElement productCode;
	@FindBy(xpath = "//input[contains(@value,'Must Sell')]") WebElement checkBoxMustSell;
	@FindBy(xpath = "//input[@value='Focused']") WebElement checkBoxFocused;
	@FindBy(xpath = "//input[@value='Promoted']") WebElement checkBoxPromoted;
	
	@FindBy(xpath = "//input[@id='nest-messages_expiry_in']") WebElement inputBestBefore;
	@FindBy(xpath = "//input[@id='nest-messages_expiry_unit']") WebElement expiryUnitDropDown;
	@FindBy(xpath = "//div[@class='ant-select-dropdown ant-select-dropdown-placement-bottomLeft ']//div[@title]") List<WebElement> expiryUnitDropDownAllOptions;
	@FindBy(xpath = "//input[@id='nest-messages_base_unit']") WebElement measurementUnitDropDown;
	@FindBy(xpath = "//div[@class='ant-select-dropdown ant-select-dropdown-placement-bottomLeft ']//div[@title]") List<WebElement> measurementUnitDropDownAllOptions;
	
	// Add Unit Code 
	@FindBy(xpath = "//span[normalize-space()='Add Unit']") WebElement addUnitButton;
	@FindBy(xpath = "//div[@class='ant-select-dropdown ant-select-dropdown-placement-bottomLeft ']//div//div[@class='rc-virtual-list']//div[@title]") List<WebElement> packagingUnitAllOptions;
	@FindBy(xpath = "//input[@id='nest-messages_unitTiers_0_from_unit']") WebElement packagingUnit;

	@FindBy(xpath = "//input[@id='nest-messages_unitTiers_0_to_unit']") WebElement packagingUnitSecond;
	@FindBy(xpath = "//div[@class='ant-select-dropdown ant-select-dropdown-placement-bottomLeft ']//div[@title]") List<WebElement> packagingUnitAllOptionsSecond;
	
	@FindBy(xpath = "//input[@id='nest-messages_unitTiers_0_conversion_factor']") WebElement containsInput;
	
//	GST Details 
	@FindBy(xpath = "//input[@id='nest-messages_hsn_code']") WebElement HSNCodeInput;
	@FindBy(xpath = "//input[@id='nest-messages_gst']") WebElement GST_Percentage;
	@FindBy(xpath = "//input[@id='nest-messages_cess']") WebElement Cess_Percentage;
	@FindBy(xpath = "//textarea[@id='nest-messages_description']") WebElement product_Description;
	
//	Image
	@FindBy(xpath = "//input[contains(@accept,'image/jpeg, image/jpg, image/png')]") WebElement ProductImage;
	@FindBy(xpath = "//input[@id='nest-messages_catalog']") WebElement Product_CatalogImage;
	@FindBy(xpath = "//button[@type='submit']") WebElement submitButton;
	@FindBy(xpath = "//span[@aria-label='close']//*[name()='svg']") WebElement closeCross;
...
//	--------------------- Check Box
	...
	public void clickProductAimCheckboxRandomly () {
	    List<Runnable> checkboxActions = Arrays.asList(
	        () -> checkBoxMustSell.click(),
	        () -> checkBoxFocused.click(),
	        () -> checkBoxPromoted.click()
	    );
